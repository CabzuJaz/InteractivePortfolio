  ...
  services: [
    {
      ...
      description:
        "I connect intake, CRM, follow-up, reporting, and approvals into one dependable workflow.",
      examples: ["Lead operations", "CRM workflows", "Notifications", "Human approval"],
    },
    {
      title: "AI workflows",
      description:
    ...
    },
    {
      ...
      description:
        "I make APIs, webhooks, databases, and business tools exchange clean, traceable data.",
      examples: ["Python services", "REST APIs", "SQL", "Webhooks"],
    },
  ],
