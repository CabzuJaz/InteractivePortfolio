...
export const skills: SkillCategory[] = [
  {
    ...
    items: [
      ...
      { name: "Codex CLI", level: 3 },
      { name: "Prompt Engineering", level: 3 },
      { name: "Human-in-the-Loop AI", level: 3 },
      { name: "n8n", level: 3 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "OpenAI Images API", level: 2 },
      { name: "Discord API", level: 3 },
  ...
  },
  {
    ...
    items: [
      { name: "Flask", level: 2 },
      { name: "SQLite", level: 3 },
      { name: "State Machines", level: 3 },
      { name: "Immutable Versioning", level: 3 },
